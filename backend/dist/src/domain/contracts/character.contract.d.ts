...
export type CharacterItemStatus = 'backpack' | 'equipped_main_hand' | 'equipped_off_hand' | 'equipped_armor' | 'equipped_shield' | 'attuned';
...
//# sourceMappingURL=character.contract.d.ts.map