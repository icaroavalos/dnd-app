...
describe('Background Parser', () => {
    ...
    it('should parse XPHB Acolyte correctly', async () => {
        ...
        assert.deepStrictEqual(parsed.skillProficiencies, ['insight', 'religion'], 'Should have Insight and Religion skills');
        ...
        assert.strictEqual(parsed.magicInitiate.className.toLowerCase(), 'cleric', 'Should be Cleric');
    });
...
//# sourceMappingURL=background-parser.test.js.map