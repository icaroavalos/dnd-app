...
if (state.step === 'lineage') renderLineageForm();
else if (state.step === 'abilities') renderAbilitiesForm();
else if (state.step === 'choices') renderChoicesForm();
else if (state.step === 'background') renderBackgroundForm();
else if (state.step === 'leveling') renderLevelingForm();
}
