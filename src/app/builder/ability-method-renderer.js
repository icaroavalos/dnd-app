/**
 * Ability Method Renderer
 *
 * Renderiza controles de método de abilities:
 * - Standard Array
 * - Point Buy
 * - Manual/Standard
 */
...
export function createAbilityMethodRenderer({
  ...
  /**
   * Renderiza controles do método de ability (standard, point buy, manual)
   */
...
`;
  ...
  /**
   * Renderiza controles do Standard Array
   */
...
`;
  ...
  /**
   * Renderiza controles do Point Buy
   */
...
`;
  ...
  /**
   * Renderiza cálculos das abilities (score cards)
   */
